...
struct spi_conf spis[] = {
	...
	[2] = {
		...
		.dev = {
			.name = "SPI2",
			.pins = {
				PIN("SCK",  GPIO_PORT_B, 10, GPIO_MODE_ALT, AF5),
	...
	[3] = {
		...
		.dev = {
			.name = "SPI3",
			.pins = {
				PIN("SCK",  GPIO_PORT_C, 10, GPIO_MODE_ALT, AF6),
				PIN("MISO", GPIO_PORT_C, 11, GPIO_MODE_ALT, AF6),
				PIN("MOSI", GPIO_PORT_C, 12, GPIO_MODE_ALT, AF6),
