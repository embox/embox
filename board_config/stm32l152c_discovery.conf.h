...
struct uart_conf uarts[] = {
	...
	[3] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_B, 10, GPIO_MODE_ALT, AF7),
				PIN("RX", GPIO_PORT_B, 11, GPIO_MODE_ALT, AF7),
			},
			.clocks = {
				VAL("UART", CLK_USART3),
			}
    ...
    [1] = {
		...
		.dev = {
			...
			.pins = {
				...
				PIN("MISO", GPIO_PORT_A, 11, GPIO_MODE_ALT, AF5),
				PIN("MOSI", GPIO_PORT_A, 12, GPIO_MODE_ALT, AF5),
				PIN("CS",   GPIO_PORT_C, 12, GPIO_MODE_OUT, NOAF),
			},
			.clocks = {
				VAL("SPI",  CLK_SPI1),
			}
