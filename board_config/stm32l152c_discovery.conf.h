...
struct uart_conf uarts[] = {
	...
	[3] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_B, 10, GPIO_MODE_AF, AF7),
				PIN("RX", GPIO_PORT_B, 11, GPIO_MODE_AF, AF7),
			},
			.clocks = {
				VAL("UART", CLK_USART3),
			}
    ...
    [1] = {
		...
		.dev = {
			...
			.pins = {
				...
				PIN("MISO", GPIO_PORT_A, 11, GPIO_MODE_AF, AF5),
				PIN("MOSI", GPIO_PORT_A, 12, GPIO_MODE_AF, AF5),
