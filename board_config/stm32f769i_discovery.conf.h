...
struct mmc_conf mmcs[] = {
	...
	[1] = {
		...
		.dev = {
			...
			.pins = {
				PIN("D0", GPIO_PORT_B, 3, GPIO_MODE_ALT, AF10),
				PIN("D1", GPIO_PORT_B, 4, GPIO_MODE_ALT, AF10),
				PIN("D2", GPIO_PORT_D, 6, GPIO_MODE_ALT, AF11),
				PIN("D3", GPIO_PORT_D, 7, GPIO_MODE_ALT, AF11),
				PIN("CK", GPIO_PORT_G, 9, GPIO_MODE_ALT, AF11),
				PIN("CMD", GPIO_PORT_G, 10, GPIO_MODE_ALT, AF11),
