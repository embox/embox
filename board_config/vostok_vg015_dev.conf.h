...
struct uart_conf uarts[] = {
	[0] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_A, 1, GPIO_MODE_ALT, 1),
				PIN("RX", GPIO_PORT_A, 0, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("", "CLK_UART0"),
			}
	...
	[1] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_A, 11, GPIO_MODE_ALT, 3),
				PIN("RX", GPIO_PORT_A, 10, GPIO_MODE_ALT, 3),
			},
			.clocks = {
				VAL("", "CLK_UART1"),
			}
	...
	[2] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_A, 5, GPIO_MODE_ALT, 1),
				PIN("RX", GPIO_PORT_A, 4, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("", "CLK_UART2"),
			}
	...
	[4] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_A, 9, GPIO_MODE_ALT, 1),
				PIN("RX", GPIO_PORT_A, 8, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("", "CLK_UART4"),
			}
...
struct spi_conf spis[] = {
	[0] = {
		...
		.dev = {
			...
			.pins = {
				PIN("CLK", GPIO_PORT_B, 0, GPIO_MODE_ALT, 1),
				PIN("FSS", GPIO_PORT_B, 1, GPIO_MODE_ALT, 1),
				// PIN("FSS", GPIO_PORT_B, 1, GPIO_MODE_OUT, -1),
				PIN("RX", GPIO_PORT_B, 2, GPIO_MODE_ALT, 1),
				PIN("TX", GPIO_PORT_B, 3, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("SPI",  "CLK_SPI0"),
			}
	...
	[1] = {
		...
		.dev = {
			...
			.pins = {
				PIN("CLK", GPIO_PORT_B, 4, GPIO_MODE_ALT, 1),
				PIN("FSS", GPIO_PORT_B, 5, GPIO_MODE_ALT, 1),
				// PIN("FSS", GPIO_PORT_B, 5, GPIO_MODE_OUT, -1),
				PIN("RX", GPIO_PORT_B, 6, GPIO_MODE_ALT, 1),
				PIN("TX", GPIO_PORT_B, 7, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("SPI",  "CLK_SPI1"),
			}
...
struct i2c_conf i2cs[] = {
	[0] = {
		...
		.dev = {
			...
			.pins = {
				PIN("SCL", GPIO_PORT_C, 12, GPIO_MODE_ALT, 1),
				PIN("SDA", GPIO_PORT_C, 13, GPIO_MODE_ALT, 1),
			},
			.clocks = {
				VAL("", "CLK_I2C0"),
			}
