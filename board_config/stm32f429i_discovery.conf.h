...
struct uart_conf uarts[] = {
 	[1] = {
		...
		.dev = {
			...
			.pins = {
				PIN("TX", GPIO_PORT_A, 9, GPIO_MODE_ALT | GPIO_MODE_OUT, AF7),
...
struct spi_conf spis[] = {
	...
	[5] = {
		...
		.dev = {
			.name = "SPI5",
			.pins = {
				PIN("SCK",  GPIO_PORT_F, 7, GPIO_MODE_ALT, AF5),
				PIN("MISO", GPIO_PORT_F, 8, GPIO_MODE_ALT, AF5),
				PIN("MOSI", GPIO_PORT_F, 9, GPIO_MODE_ALT, AF5),
