...
class FORTE_LED_OFF: public CFunctionBlock {
  DECLARE_FIRMWARE_FB(FORTE_LED_OFF)
...
public:
   FORTE_LED_OFF(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CFunctionBlock( pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, m_anFBConnData, m_anFBVarsData) {
   };

  virtual ~FORTE_LED_OFF() = default;
};
