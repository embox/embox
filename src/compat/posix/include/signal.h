...
typedef void (*signal_hndfn)(int);

extern signal_hndfn signal(int sig, signal_hndfn fn);

#define SIG_DFL ((signal_hndfn) 0x1)
#define SIG_IGN ((signal_hndfn) 0x3)
#define SIG_ERR ((signal_hndfn) 0x5)
