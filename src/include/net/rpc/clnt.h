...
extern struct client * clnt_create(const char *host, __u32 prognum,
...
#if 0
extern struct client * clntraw_create(__u32 prognum, __u32 versnum);

extern struct client * clnttcp_create(struct sockaddr_in *addr, __u32 prognum,
		__u32 versnum, int *psock, unsigned int sendsz, unsigned int __recvsz);
