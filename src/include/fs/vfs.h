...
extern int vfs_set_path (char *path, node_t *nod);
extern void vfs_cut_mount_dir(char *path, char *mount_dir) ;
extern int vfs_nip_tail(char *head, char *tail);
extern int vfs_increase_tail(char *head, char *tail);
