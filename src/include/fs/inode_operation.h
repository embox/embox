...
struct inode_operations {
	int           (*ino_create)(struct inode *i_new, struct inode *i_dir,
								int mode);
	...
	int           (*ino_getxattr)(struct inode *node, const char *name,
									char *value, size_t size);
	int           (*ino_setxattr)(struct inode *node, const char *name,
