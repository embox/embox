...
static void test_softirq_handler(softirq_nr_t softirq_nr, void *data) {
	test_emit_into(&softirq_out, 'c');
	test_emit_into(&softirq_out, (int) data);
	test_emit_into(&softirq_out, 'e');
}
