...
#ifndef RISCV_KERNEL_SBI_H_
#define RISCV_KERNEL_SBI_H_

#define RISCV_SMODE 1
...
extern struct sbiret sbi_ecall(unsigned long arg0, unsigned long arg1,
