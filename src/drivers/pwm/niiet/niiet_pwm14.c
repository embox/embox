...
#if defined(CONF_PWM14_PIN_OUT0_PORT)
...
#if defined(CONF_PWM14_PIN_OUT1_PORT)
...
#if defined(CONF_PWM14_PIN_OUT2_PORT)
...
#if defined(CONF_PWM14_PIN_OUT3_PORT)
...
#if defined(CONF_PWM14_DMA_OUT0_NUM)
#define DMA0_EN     1
...
#if defined(CONF_PWM14_DMA_OUT1_NUM)
#define DMA1_EN     1
...
#if defined(CONF_PWM14_DMA_OUT2_NUM)
#define DMA2_EN     1
...
#if defined(CONF_PWM14_DMA_OUT3_NUM)
#define DMA3_EN     1
...
#endif /* defined CONF_PWM14_ENABLED */
