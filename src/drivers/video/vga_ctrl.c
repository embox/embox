...
//static void write_pixel2(struct display *display, unsigned x, unsigned y, unsigned c) {
...
static void write_pixel8(struct display *display, unsigned x, unsigned y, unsigned c)
{
	unsigned wd_in_bytes;
	unsigned off;
...
static struct display display_types[] = {
		{VESA_MODE_TEXT_80x25x16, 80, 25, g_80x25_text, NULL},
		{VESA_MODE_VGA_640x480x16, 640, 480, g_640x480x16, write_pixel4p},
		{VESA_MODE_VGA_320x200x256, 320, 200, g_320x200x256, write_pixel8}
};
