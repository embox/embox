...
static void diag_vterm_cursor(struct vterm_video *t, unsigned short x,
	unsigned short y) {
	unsigned int pos;
...
static void diag_vterm_putc(struct vterm_video *t, char ch, unsigned short x,
	unsigned short y) {
	struct diag_vterm_data *data = &member_cast_out(t, struct vga_vterm_video,
			video)->data;
...
static void diag_vterm_clear_rows(struct vterm_video *t, short row,
