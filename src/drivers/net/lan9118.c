...
static void lan9118_reg_write(struct net_device *dev, int offset,
	uint32_t mask) {
...
static void lan9118_mac_write(struct net_device *dev, unsigned int offset,
	uint32_t val) {
	uint32_t l;
...
static int lan9118_xmit(struct net_device *dev, struct sk_buff *skb) {
	...
	freespace =
		lan9118_reg_read(dev,
			LAN9118_TX_FIFO_INF) & _LAN9118_TX_FIFO_INF_TDFREE;
...
static uint32_t lan9118_rx_status(struct net_device *dev) {
	...
	rx_status =
		lan9118_reg_read(dev,
			LAN9118_RX_FIFO_INF) & _LAN9118_RX_FIFO_INF_RXSUSED;
...
static int lan9118_open(struct net_device *dev) {
	...
	lan9118_reg_write(dev, LAN9118_INT_EN,
		(_LAN9118_INT_EN_SW | _LAN9118_INT_EN_RSFL));
