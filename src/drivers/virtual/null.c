...
static ssize_t null_read(struct char_dev *cdev, void *buf, size_t nbyte, int flags) {
	return 0;
}

static ssize_t null_write(struct char_dev *cdev, const void *buf, size_t nbyte,
    int flags) {
	return nbyte;
}
