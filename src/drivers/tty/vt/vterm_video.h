...
struct vterm_video_ops {
	...
	void (*putc)( struct vterm_video *t, char ch, unsigned short x,
		unsigned short y);
	void (*clear_rows)(struct vterm_video *t, short row, unsigned short count);
	void (*copy_rows)(struct vterm_video *t, unsigned short to,
		unsigned short from, short nrows);
};
...
extern int vterm_video_init(struct vterm_video *vi,
	const struct vterm_video_ops *ops,
