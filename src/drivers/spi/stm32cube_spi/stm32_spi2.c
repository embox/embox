...
#define SPI_REGION_BASE        ((uintptr_t)CONF_SPI2_REGION_BASE)
#else
#define SPI_REGION_BASE         SPI2
#endif /* defined CONF_SPI2_REGION_BASE */

#define CLK_ENABLE_SPI          CONF_SPI2_CLK_ENABLE_SPI

#define SPI_PIN_SCK_PORT        CONF_SPI2_PIN_SCK_PORT
#define SPI_PIN_SCK_NR          CONF_SPI2_PIN_SCK_NR
#define SPI_PIN_SCK_AF          CONF_SPI2_PIN_SCK_AF

#define SPI_PIN_MISO_PORT       CONF_SPI2_PIN_MISO_PORT
#define SPI_PIN_MISO_NR         CONF_SPI2_PIN_MISO_NR
#define SPI_PIN_MISO_AF         CONF_SPI2_PIN_MISO_AF

#define SPI_PIN_MOSI_PORT       CONF_SPI2_PIN_MOSI_PORT
#define SPI_PIN_MOSI_NR         CONF_SPI2_PIN_MOSI_NR
#define SPI_PIN_MOSI_AF         CONF_SPI2_PIN_MOSI_AF
...
SPI_CONTROLLER_DEF(MACRO_CONCAT(SPI_DEV_NAME,0), &stm32_spi_ops, &stm32_spi2, SPI_BUS_NUM);

#define SPI_DEV_NAME      MACRO_CONCAT(SPI_BUS_NAME,_dev)

SPI_DEV_DEF(MACRO_CONCAT(SPI_DEV_NAME,0), NULL, &stm32_spi2, SPI_BUS_NUM);
