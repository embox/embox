...
#define MMC_CSD_V2_MASK        0x40000000
#define MMC_STD_CAPACITY_MULT  (256 * 1024)
#define MMC_HIGH_CAPACITY_MULT (512 * 1024)
#define MMC_BYTE_MASK          0xFF
#define MMC_BYTES_PER_BLOCK    512u
