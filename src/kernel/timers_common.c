...
static volatile __u32 cnt_ms_sleep; /**< for sleep function */
static volatile __u32 cnt_sys_time; /**< quantity ms after start system */
...
int set_timer (__u32 id, __u32 ticks, TIMER_FUNC handle) {
	__u32 i;
