...
void print_header(Elf32_Ehdr *head) {
    ...
    case 0: printf("EFLCLASSNONE - Invalid class");
        break;
    case 1: printf("ELFCLASS32 - 32-bit objects");
        break;
    case 2: printf("ELFCLASS64 - 64-bit objects");
        break;
    default: printf("Unknown class (%d)", head->e_ident[4]);
        break;
    }
    printf("\n");
    ...
    case 0: printf("ELFDATANONE - Invalid data encoding");
        break;
    case 1: printf("ELFDATA2LSB");
        break;
    case 2: printf("ELFDATA2MSB");
        break;
    default: printf("Unknown data encoding (%d)", head->e_ident[5]);
        break;
    }
    printf("\n");
    ...
    case 0: printf("EV_NONE - Invalid version");
        break;
    case 1: printf("EV_CURRENT - Current version");
        break;
    default: printf("Unknown version (%d)", head->e_ident[6]);
        break;
    }
    printf("\n");
    ...
    switch (x) {
    case 0: printf("ET_NONE - No file type");
        break;
    case 1: printf("ET_REL - Relocatable file");
        break;
    case 2: printf("ET_EXEC - Executable file");
        break;
    case 3: printf("ET_DYN - Shared object file");
        break;
    case 4: printf("ET_CORE - Core file");
        break;
    default:
    ...
    switch (x) {
    case 0: printf("EM_NONE - No machine");
        break;
    case 1: printf("EM_M32 - AT&T WE 32100");
        break;
    case 2: printf("EM_SPARC - SPARC");
        break;
    case 3: printf("EM_386 - Intel 80386");
        break;
    case 4: printf("EM_68K - Motorola 68000");
        break;
    case 5: printf("EM_88K - Motorola 88000");
        break;
    case 7: printf("EM_860 - Intel 80860");
        break;
    case 8: printf("EM_MIPS - MIPS RS3000");
        break;
    default: printf("%d", x);
    }
    printf("\n");
...
void print_sections(Elf32_Shdr *sections, char *names, int count, uint8_t rev) {
    int i;
    if (names == NULL) {
        return;
    }
...
void print_section_head(Elf32_Shdr *section_header, uint8_t rev,   \
    ...
    if (flags & 0x0ff00000) {
        printf("(SHF_MASKOS flags = 0x%x) ", (flags >> 20) & 0xff);
    }
    if (flags & 0xf0000000) {
        printf("(SHF_MASKPROC flags = 0x%xu)", (flags >> 28) & 0xf);
    }
    printf("\n");
...
static int exec(int argsc, char **argsv) {
    ...
    FILE *f;
    Elf32_Ehdr head;
    Elf32_Shdr sections[MAX_SECTIONS];
